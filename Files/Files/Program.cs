...
namespace Files
{
    internal class Program
    {
        ...
        class Person
        {
            ...
            {
                string fileName = "U:\\PRG\\test_repo\\Files\\" + Name + ".txt.";
            ...
            {
                Console.Write("Load who?:");
                string nameForLoad = Console.ReadLine();
                //File.ReadAllText("U:\\PRG\\test_repo\\Files" + nameForLoad + ".txt");
                using (StreamReader reader = new StreamReader("U:\\PRG\\test_repo\\Files\\" + nameForLoad + ".txt."))
                {
                    string readLine = reader.ReadLine();
                }
                Person person = new Person();
                person.Name = nameForLoad;
                ...
                return person; // Prepiste tento radek tak, ze v nem budete vracet vytvorenou instanci Person (osobu nactenou ze souboru)
            }
